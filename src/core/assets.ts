...
export class AssetManager {
    ...
    private models : AssetContainer<Model>;
    ...
    constructor(audio : AudioPlayer) {
        ...
        this.models = new AssetContainer<Model> ();
    ...
    public loadBitmap(name : string, url : string, repeatFlag = 0) {
        ...
        image.onload = () => {
            ...
            ++ this.loaded;
            this.bitmaps.addAsset(name, 
                this.canvas.createBitmap(image, repeatFlag));
        }
        image.src = url;
    }
    ...
    public loadModel(name : string, url : string) {
